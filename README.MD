...
### Compilation
OpenInv now builds with Gradle 8.14.3 using Paperweight userdev for Purpur `1.19.4` on Java 17 / GraalVM 17.

Build the plugin with:
`./gradlew build`

The server-ready shaded jar is written to:
`build/libs/OpenInv-${version}.jar`
