...
public enum Permissions {
    ...
    SEARCH("search"),
    SEARCH_PLAYERS_ONLINE("search.players.online"),
    SEARCH_PLAYERS_OFFLINE("search.players.offline"),
    SEARCH_CHUNKS_LOADED("search.chunks.loaded"),
    SEARCH_CHUNKS_UNLOADED("search.chunks.unloaded"),
    EDITINV("editinv"),
    EDITENDER("editender"),
    OPENSELF("openself"),
